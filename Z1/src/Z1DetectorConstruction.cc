...
//
//
/// \file Z1DetectorConstruction.cc
/// \brief Implementation of the Z1DetectorConstruction class

#include "Z1DetectorConstruction.hh"
...
Z1DetectorConstruction::Z1DetectorConstruction()
...
G4VPhysicalVolume* Z1DetectorConstruction::Construct()
{  
  ...
  G4ThreeVector pos1 = G4ThreeVector(0, 0, -0.3*cm);
  ...
  new G4PVPlacement(0,                       //no rotation
                    ...
                    0,                       //copy number
                    checkOverlaps);          //overlaps checking
  G4VisAttributes* Shape1_logVisAtt
		= new G4VisAttributes(G4Colour(0.5,0.50,0.50));//gray
  logicShape1->SetVisAttributes(Shape1_logVisAtt);
  //     
  // Shape 2
  //
  G4Material* shape2_mat = nist->FindOrBuildMaterial("G4_Cu");
  G4ThreeVector pos2 = G4ThreeVector(0, 0, -0.1*cm);
  ...
  new G4PVPlacement(0,                       //no rotation
                    ...
                    0,                       //copy number
                    checkOverlaps);          //overlaps checking
  G4VisAttributes* Shape2_logVisAtt
                = new G4VisAttributes(G4Colour(1.0,1.0,0));//yellow
       logicShape2->SetVisAttributes(Shape2_logVisAtt);
  ...
  G4ThreeVector pos3 = G4ThreeVector(0, 0, 5*cm);

  G4double shape3_rin =  0.*cm;
  G4double shape3_rout =  0.5*7.6 *cm;
